...
public class SearchActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    // load views
    final AutoCompleteTextView eventACTV=
        (AutoCompleteTextView) findViewById(R.id.ds_tournament_input);
    ...
    eventACTV.addTextChangedListener(new TextWatcher() {
      ...
      public void afterTextChanged(Editable arg0) {
        eventInputSearchButton.setEnabled(eventACTV.getText().toString().length()>0);
      }
    ...
    ArrayAdapter<String> titleAdapter=
        new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, tournamentTitles);
    ...
    ArrayAdapter<CharSequence> formatAdapter=ArrayAdapter
        .createFromResource(this, R.array.search_formats, android.R.layout.simple_spinner_item);
    ...
    // setup rooms spinner
    ArrayAdapter<CharSequence> roomAdapter=ArrayAdapter
        .createFromResource(this, R.array.rooms_available, android.R.layout.simple_spinner_item);
